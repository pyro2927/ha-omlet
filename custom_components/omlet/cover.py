...
class OmletCover(CoordinatorEntity, CoverEntity):
    ...
    def is_closed(self) -> bool | None:
        ...
        if not self.available:
            return None
        return self.coordinator.data[self._device_id].get(ATTR_DOOR_STATE) == DOOR_STATE_CLOSED
    ...
    def is_opening(self) -> bool:
        ...
        if not self.available:
            return False
        return self.coordinator.data[self._device_id].get(ATTR_DOOR_STATE) == DOOR_STATE_OPENING
    ...
    def is_closing(self) -> bool:
        ...
        if not self.available:
            return False
        return self.coordinator.data[self._device_id].get(ATTR_DOOR_STATE) == DOOR_STATE_CLOSING
